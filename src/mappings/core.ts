...
export function handleTransfer(event: Transfer): void {
  ...
  if (from.toHexString() != ADDRESS_ZERO && from.toHexString() != pair.id) {
    ...
    fromUserLiquidityPosition.liquidityTokenBalance = convertTokenToDecimal(/**pairContract.balanceOf(from) */ BigInt.fromI32(1000), BI_18)
  ...
  if (event.params.to.toHexString() != ADDRESS_ZERO && to.toHexString() != pair.id) {
    ...
    toUserLiquidityPosition.liquidityTokenBalance = convertTokenToDecimal(/**pairContract.balanceOf(to) */BigInt.fromI32(2000), BI_18)
